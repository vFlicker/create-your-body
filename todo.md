...
(10 _ userData.weight) + (6.25 _ userData.height) - (5 _ userData.age) + 5 :
(10 _ userData.weight) + (6.25 _ userData.height) - (5 _ userData.age) - 161;
...
case 'deficit':
userData.targetCalories = Math.round(userData.totalCalories _ 0.85); // -15%
break;
case 'maintain':
userData.targetCalories = userData.totalCalories;
break;
case 'surplus':
userData.targetCalories = Math.round(userData.totalCalories _ 1.15); // +15%
break;
}
}
