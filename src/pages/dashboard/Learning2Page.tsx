...
export function Learning2Page(): JSX.Element {
  ...
  if (!user || isLoading) {
    return <CommonPageLayout title="Обучение [2]" isLoading={isLoading} />;
  }

  const handleProductClick = (productId: number) => {
    navigate(
      AppRoute.Learning2Product.replace(':productId', String(productId)),
    );
  };

  return (
    <CommonPageLayout title="Обучение [2]">
