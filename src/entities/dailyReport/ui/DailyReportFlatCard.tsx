...
export function DailyReportFlatCard({
  className,
  calories,
  carbs,
  fats,
  ...
  steps,
  weight,
}: DailyReportFlatCardProps): JSX.Element {
  return (
    <StyledDailyReportFlatCardWrapper className={className}>
      <StyledMetrics>
    ...
    </StyledDailyReportFlatCardWrapper>
  );
}

const StyledDailyReportFlatCardWrapper = styled.div`
  display: flex;
